      ...
      <AuthProvider>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path='/dash-board/blog/update/:blogId' element={<UpdateBlogs />}></Route>
            <Route path='/dash-board/instagram/update/:instagramId' element={<UpdateInstagram />}></Route>
            <Route path='/dash-board/project/update/:projectId' element={<UpdateProject />}></Route>
            <Route path='/dash-board/slider/update/:sliderId' element={<UpdateSlider />}></Route>
